...
- No Phase 2 living-document impact. The complete data flow and user documentation are explicitly assigned to Phase 5.
- Recommended: none for this phase.

### How-to Impact
- The new site-selection action needs end-to-end how-to coverage only after subscriptions and client apply exist; Phase 5 owns it.
- Recommended: none for this phase.
